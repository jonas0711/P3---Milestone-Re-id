...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/images/Dataset_visu/Market-1501_examples_v4.png}
    \caption{Market-1501}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/images/Dataset_visu/MSMT17_examples_v4.png}
    \caption{MSMT17}
