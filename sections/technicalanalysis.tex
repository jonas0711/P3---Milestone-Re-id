...
\\\\
While \acs{OSNet} presents a lightweight architecture with state-of-the-art competitive performance, the approach does not consider image quality issues, such as poor lighting or shifting between different types of cameras. 
...
\section{Related work for Super-Resolution Re-Identification}\label{sec:superres-reid}
