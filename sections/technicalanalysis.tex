...
\textbf{mAP}    & 63.4\%  & 63.4\%  & 58.8\% & 44.4\% \\ \hline
...
Heavy 25\\ \hline
\textbf{mAP}    & 63.4\%& 63.4\%& 59.3\%& 57.6\%\\ \hline
...
\begin{tabular}
    ...
    |}
\hline
\multicolumn{3}{|c|}{\cellcolor[HTML]{D8E9F7}\textbf{Test on Abnormal and Unseen Data}}\\\hline
\rowcolor[HTML]{D8E9F7}
{} & Unmodifed (Market-1501)& New dataset (iLIDS-VID)\\ \hline
\textbf{mAP}    & 63.4\%& 35.1\%\\ \hline
\textbf{Rank-1} & 52.0\%& 16.0\%\\ \hline
\textbf{Rank-5} & 76.0\%& 60.0\%\\ \hline
\textbf{Rank-10}& 84.0\%& 76.0\%\\ \hline
\textbf{Rank-20}& 100.0\%& 96.0\%\\ \hline
\end{tabular}
...
\subsubsection{Enhanced Deep Residual Networks for Single Image Super-Resolution}
A breakthrough paper from 2017. Built upon conventional residual networks by removing modules deemed to be unnecessary, and further improved performance by expanding model size and stabilizing training. The paper produced two models, EDSR and MDSR respectively. The former, \textbf{E}Ehanced \textbf{D}eep \textbf{S}uper-\textbf{R}esolution, is a single-scale model, and the later, \textbf{M}ulti-scale \textbf{D}eep \textbf{S}uper-\textbf{R}esolution, is a smaller model with fewer parameters, which achieved comparable performance to the single-scale architecture. EDSR also appears in \cite{Blau2018PerceptionDistortion}, and can be found in the graphs in Appendix \ref{app:perception-distortion-graphs}, from which EDSR consistently lands ahead of the other networks, when prioritizing low distortion.
\\\\
