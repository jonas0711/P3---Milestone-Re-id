...
The best performing model in 4/5 scenarios was the \hyperlink{model:baseline}{Baseline} model, indicating that while improvements through \acs{SR} are possible, they require careful tuning and appropriate training strategies. The problem statement was answered in terms of design, integration, and deployment.
\\\\
...
\\\\
Future work should focus on obtaining diverse cultural, geographical, and environmental datasets, appropriate training strategies for \acs{SR}, and hyperparameter tuning for the \acs{ReID} model. 
